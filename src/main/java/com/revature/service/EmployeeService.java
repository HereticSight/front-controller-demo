 ...
 * whereas the DAO layer is responsible for the persistence logic (anything to do with the
 * Session and Hibernate's Session methods
 *
 */
public class EmployeeService {
	 ...
	 * 
	 * Every time we instantiate an EmployeeService object, it has 
	 * a fully initialized DAO
	 */
	...
	/**
	 * the confirmLogin() method will return the Employee that has successfully
	 * logged in(meaning that their username and password match a unique record in the DB)
	 * If the username & pass doesn't match a record, return null. 
	 */
